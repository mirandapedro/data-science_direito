# -*- coding: utf-8 -*-
"""
Created on Fri Mar 19 10:36:16 2021
...
numero = dsd.extrair(html, "(Med. Liminar) - ", "<")
relator = dsd.extrair(html, "</td><td><strong>MINISTRO ", "<")
requerente = dsd.extrair(html, "Requerente: <strong>", "<")

lista.append(numero)
lista.append(relator)
lista.append(requerente)
